        ...
        <div class="card-header" style="padding: 0%">
                <nav class="navbar navbar-expand-md menu">
                  <ul class="navbar-nav btn-block">
                    ...
                    <li class="nav-item link col-md-4" style="padding: 0%">
                      <a class="nav-link link active col-md-12 badge-light" href="{{ route('club.informacion_club_gestiones', $club->id_club) }}">Gestiones</a>
                    </li>
                    <li class="nav-item link col-md-4" style="padding: 0%">
                      <a class="nav-link link col-md-12 badge-light" href={{ route('club.informacion_club_logros',$club->id_club) }}>Logros</a>
                    </li>
                    ...
                    <thead class="thead-light">
                      ...
                      <tbody class="table-sm" id="datos">
                        ...
                        <tr>
                          ...
                          <td  rowspan="{{count($inscripcion->gestion->club_participaciones->where('id_club',$club->id_club))+1}}">
                            {{$inscripcion->gestion->nombre_gestion}}
                          </td>
                            ...
                            @if (count($inscripcion->gestion->club_participaciones->where('id_club',$club->id_club))>0)
                              @foreach ($inscripcion->gestion->club_participaciones->where('id_club',$club->id_club) as $disc)
                                  <tr>
                                      ...
                                      {{$disc->disciplina->categoria == 1 ? 'Damas':($disc->disciplina->categoria == 2 ? 'Varones':'Mixto')}}</td>
