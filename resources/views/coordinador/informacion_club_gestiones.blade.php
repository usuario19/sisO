        ...
        <div class="card-header" style="padding: 0%">
            <nav class="navbar navbar-expand-md table-bordered menu">
                <ul class="navbar-nav btn-block">
                  ...
                  <li class="nav-item link col-md-4">
                      <a class="nav-link link active col-md-12" href="{{ route('coordinador.informacion_club_gestiones', $club->id_club) }}">GESTIONES</a>
                    </li>
                  ...
                  <tbody id="datos">
                    ...
                    <tr>
                      ...
                      <td style="width: 70px" class="text-center" rowspan="{{count($inscripcion->gestion->club_participaciones->where('id_club',$club->id_club))+1}}"> 
                        ...
                        <a href="#" data-toggle="modal" class="btn btn-warning btn_hover" data-target="#V{{ $inscripcion->gestion->id_gestion.$club->id_club }}">
                          <span class="">
                      ...
                      @foreach ($inscripcion->gestion->club_participaciones->where('id_club',$club->id_club) as $disc)
                          <tr>
                              ...
                              <td style="width: 50px" class="text-center">
                                <a href="{{ route('disciplina.eliminar',$disc->id_club_part) }}" data-toggle="modal" class="btn btn-outline-secondary button btn_hover" data-target="#Eliminar{{ $disc->id_club_part}}" >
                                  <span class="">
