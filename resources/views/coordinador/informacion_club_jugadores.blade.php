            ...
            <div class="card-body" style="padding: 0%">{{-- <br>
                <table class="table table-sm">
                      ...
                      <tr>
                        ...
                        <td> --}}
                         <div class="form-row" style="padding:15px 15px 0px 15px">
                ...
                <div class="table-responsive-xl">
                    <div class="col-md-12" style="padding: 0%">
                      <table class="mi_tabla table table-striped ">
                        ...
                        <tbody id="datos">
                          ...
                          @foreach($mis_jugadores as $usuario)
                            <tr  class="link_pointer" style="cursor:pointer" data-href="{{ route('jugador.informacion',$usuario->id_jugador) }}">
                              ...
                              <th>{{$i}}</th>
                              <td data-href="{{ route('jugador.informacion',$usuario->id_jugador) }}">
                                <img class="rounded-circle mx-auto d-block" src="/storage/fotos/{{ $usuario->jugador->foto_jugador }}" alt="" height=" 50px" width="50px">
                              </td>
                              ...
                              <td>
                                <a href="#confirm?"  class="button_delete" data-toggle="modal" data-target="#Eliminar{{ $usuario->id_jugador}}" >
