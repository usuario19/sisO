...
{!! Form::open(['route'=>'coordinador.filtrar','method'=>'post']) !!}
  <div class="form-row">
    <div class="form-group col-md-3">
      {!! Form::label('club', 'Seleccione club:', []) !!}
      {!! Form::select('club', $clubs,0,['class'=>'form-control','id'=>'club']) !!}
    </div>
    <div class="form-group col-md-3">
      {!! Form::label('genero', 'Seleccione genero:', []) !!}
      {!! Form::select('genero', ['0'=>'Mostrar Todo', '1'=>'Femenino', '2'=>'Masculino'],0,['class'=>'form-control', 'id'=>'genero']) !!}
    </div>
    <div class="form-group col-md-3">
      <a href="#" id="buttonEnviar" class="btn btn-primary"> Filtrar</a>
