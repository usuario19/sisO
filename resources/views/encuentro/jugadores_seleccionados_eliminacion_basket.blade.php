        ...
        <div class="container">
          <div class="">
            <div class="row col-md-12 margin_none">
              ...
              <div class="form-group col-md-3">
                <button type="button" href=" " onclick="RegistrarResultadoBasket({{ $encuentro->id_encuentro }});" class="btn btn-warning btn-block" data-toggle="modal" data-target="#modalResultadoBasket">
                    <div class="button-div" style="width: 100px">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row col-md-12">
                        <div class="form-group col-md-10" style="min-height:76px">
                    ...
                    <div class="table-responsive-xl">
                      <table class="table mi_tabla table-bordered table-sm">
                        <thead>
                          <th width="30">ID</th>
                          <th>Jugador</th>
                          <th>J.D.</th>
