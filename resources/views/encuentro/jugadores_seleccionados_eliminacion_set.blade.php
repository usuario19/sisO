  ...
  <div class="margin_top col-md-9">
    <div class="">
      <div class="card-">
        ...
        @include('encuentro.modal_agregar_resultado_set')
        @include('encuentro.modal_ver_res_set')
        <div class="container">
        ...
        <div class="container">
          <div class="">
            <div class="row col-md-12 margin_none">
              ...
              <div class="form-group col-md-3">
                <button type="button" href=" " onclick="RegistrarResultadoSet({{ $encuentro->id_encuentro }});" class="btn btn-warning btn-block" data-toggle="modal" data-target="#modalResultadoSet">
                    <div class="button-div" style="width: 100px">
