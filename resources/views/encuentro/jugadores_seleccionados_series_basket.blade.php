  ...
  <div class="margin_top col-md-9">
    <div class="">
      <div class="card-">
        ...
        @include('encuentro.modal_agregar_resultado_basket')
        @include('encuentro.modal_ver_res_basket')
        <div class="container">
          ...
          <div class="">
            <div class="form-row col-md-12 margin_none">
              ...
              <div class="form-group col-md-3">
                <button type="button" onclick="VerResultadoBasket({{ $encuentro->id_encuentro }});" class="btn btn-success btn-block" data-toggle="modal" data-target="#modalVerResultadoBasket">
              ...
              <div class="form-group col-md-3">
                <button onclick="RegistrarResultadoBasket({{ $encuentro->id_encuentro }});" type="button_add" class="btn btn-warning btn-block" data-toggle="modal" data-target="#modalResultadoBasket">
                  <div class="button-div" style="width: 100px">
                    ...
                    <div class="table-responsive-xl">
                      <table class="table mi_tabla table-sm table-hover text-center table-bordered">
                        <thead>
                          <th width="30">ID</th>
                          <th>Jugador</th>
                          <th title="Jugador destacado" style="cursor: context-menu;">J.D.</th>
                          <th title="Faltas" style="cursor: context-menu;">F.</th>
                          <th width="30"></th>
                        </thead>
                        <tbody>
