    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header" style="display: flex; align-items: center;">
                <img class="mr-1 img_tb_info" src="/storage/logos/raqueta.png" alt="">
            ...
            <div class="modal-body">
                <div class="container padd_none">
                    ...
                    <div class="form-row">
                        <div class="form-group container col-md-12 d-none">
                            {!! Form::text('set_jugados',3, ['id'=>'set_jugados','class'=>'form-control']) !!}
                        </div>
                    </div>
                        ...
                        <div class="form-group col-md-6">
                            <div class="card">
                                ...
                                <div class="margin_top col-md-12">
                                    ...
                                    {!! Form::label('set_ganados1', 'Total canchas ganadas', []) !!}
                        ...
                        <div class="form-group col-md-6">
                            <div class="card">
                                ...
                                <div class="margin_top col-md-12">
                                    ...
                                    {!! Form::label('set_ganados2', 'Total canchas ganadas', []) !!}
