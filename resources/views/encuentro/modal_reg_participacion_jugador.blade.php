{!! Form::open(['route'=>'encuentro.store_puntos_jugador','method' => 'POST']) !!}
                ...
                <div class="row">
                    ...
                    <div class="form-row col-md-6">
                      ...
                      <div class="form-group">
                        {!! Form::checkbox('destacado', '1', null, ['id'=>'destacado']) !!}
                        {!! Form::label('destacado', "Este jugador se destaco.", ['class'=>'form-group']) !!}
                      </div>
                      <div class="form-group">
                        {!! Form::label('faltas', 'Faltas', []) !!}
                        {!! Form::text('faltas', null, ['class'=>'form-group form-control']) !!}
                      </div>
...
{!! Form::close() !!}
<script>
    var reg_puntos_jugador = function(id_jugador) {
        var id_encuentro =$('#id_encuentro').val();
        var destacado =$('#destacado').prop('checked',false);
