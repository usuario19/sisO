...
<!-- Modal -->
<div class="modal fade" id="modalVerResultadoFutbol" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
                    ...
                    <div class="form-row col-12">
                        <div class="form-group col-4">
                            ...
                            <div class="col-md-12" style="text-align: center;">
                                <img id="imgClub1" class="rounded mx-auto d-block" src="" alt="" height=" 100px" width="100px">                                {!! Form::label('club1',null, ['id'=>'nombre_club_fut1']) !!}
                            </div>
                        </div>
                        <div class="form-group col-4">
                            <div class="form-row">
                                <div class="form-group col-4" style="text-align: center;">
                                    <h1 class="text-center" id='goles_fut1'></h1>
                                </div>
                                <div class="form-group col-4">
                                    <h3 class="text-center">-</h3> 
                                </div>
                                <div class="form-group col-4" style="text-align: center;">
                                    <h1 class="text-center" id='goles_fut2'></h1>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-4">
                            ...
                            <div class="col-md-12" style="text-align: center;">
                                <img id="imgClub2" class="rounded mx-auto d-block" src="" alt="" height=" 100px" width="100px">                                {!! Form::label('club2',null, ['id'=>'nombre_club_fut2']) !!}
                            </div>
                        </div>
                    </div>
                </div>
      ...
      $.get(route, function(data) {
          ...
          $(data).each(function(key,value){
                ...
                if (value.puntos_extras != null) {
                    ...
                    $("#goles_fut"+i).text(value.goles + value.puntos_extras);
                    $("#div-puntos_extras").show();
                }
                if (value.penales !== null) {
                    $("#penales_fut"+i).text(value.penales);
                    $("#div-penales").show();
                }
                //alert(value.goles);
