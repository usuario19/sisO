            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="mx-auto col-12">
                        ...
                        <div class="div_sets form-row">
                            <div id="p_set_g1" class="col-3 alert-primary border"></div>
                            <div id="p_set11" class="col-3  border"></div>
                            <div id="p_set21" class="col-3  border"></div>
                            <div id="p_set31" class="col-3  border"></div>
                        </div>
                        <div class="div_sets form-row">
                            <div id="p_set_g2" class="col-3  alert-primary border"></div>
                            <div id="p_set12" class="col-3  border"></div>
                            <div id="p_set22" class="col-3  border"></div>
                            <div id="p_set32" class="col-3  border"></div>
                        </div>
                    </div>
                </div>
            </div>
