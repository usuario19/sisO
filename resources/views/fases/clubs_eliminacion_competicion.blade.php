...
@section('title') SisO - Lista de Participantes
@endsection
    ...
    <div class="margin_top col-md-9">
        ...
        <div class="container">
            <div class="card-">
                ...
                @include('fases.modal_agregar_jugadores_eliminacion')
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="50"><img class="" src="/storage/logos/{{ $jugador->logo}}" alt="" height=" 50px" width="50px"></td>
                                ...
                                <td width="50" class="text-center"><a href="{{ route('fase.eliminar_jug_eliminacion_competicion',[$fase->id_fase,$jugador->id_seleccion]) }}"><i title="Eliminar" class="material-icons delete_button">delete</i></a></td>
                            </tr>
                            @php($i+=1)
                            @endforeach
                        </tbody>
