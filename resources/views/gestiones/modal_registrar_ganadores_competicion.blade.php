                            ...
                            <div style="display: none">
                                ...
                                <div class="container col-md-12" id="resultado">
                                       <div class="form-row">
                                                ...
                                                {!! Form::select('1', [], null, ['id'=>'1','class'=>'form-control','placeholder'=>'Seleccione','required'=>'required']) !!}
                                             
                                       </div>
                                       <div class="form-row ">
                                       {!! Form::label('segundo', 'Segundo lugar:', []) !!}
                                       {!! Form::select('2', [], null, ['id'=>'2','class'=>'form-control','placeholder'=>'Seleccione','required'=>'required']) !!}
                                    </div>
                                    <div class="form-row">
                                       {!! Form::label('tercero', 'Tercer lugar:', []) !!}
                                       {!! Form::select('3', [], null, ['id'=>'3','class'=>'form-control','placeholder'=>'Seleccione','required'=>'required']) !!}
                                    </div>
                                </div>
                        </div>
                    </div>    
