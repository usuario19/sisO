...
<div class="form-row">
        ...
        <div class="form-group col-md-12">
          ...
          <nav class="navbar navbar-expand-lg menu">
            <ul class="navbar-nav btn-block">
              ...
              <li class="nav-item link competicion col-md-4">
                <a class="nav-link link  active  col-md-12" href="{{ route('grupo.encuentros_grupo_competicion',[$grupo->id_grupo, $fase->id_fase,$disciplina->id_disc,$gestion->id_gestion]) }}">3. Registrar encuentros</a>
              </li>
            </ul>
  ...
  @include('encuentro.modal_agregar_competicion_set')
  @include('encuentro.modal_agregar_resultado_competicion_ajedrez')
  @include('encuentro.modal_ver_resultado_competicion')
      <div class="form-row container">
        ...
        <div class="form-group col-md-3">
          <button type="button_add" class="btn btn-success btn-block" data-toggle="modal" data-target="#modalEncuentro">
                ...
                </button> {{-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalEncuentro">
             Agregar  --}}
          </button>
        </div>
      </div>
