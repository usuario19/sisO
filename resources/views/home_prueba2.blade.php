  ...
  <div class="mx-auto col-md-12">
    <div class="row">
      ...
      <div class="col-md-9" style="padding: 0%">
            ...
            <div class="pos-f-t my-1">
              <nav class="navbar navbar-light p-0">
                <div class="navbar_disc col-md-12">
                  <a class="navbar-brand w-100" href="#" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01"
                    ...
                    <h6 class=" text-uppercase m-0" style="color:; padding-inline-start: 12px;font-weight:bolder;">
                      <span style="padding-right: 10px"><img class="mx-auto" src="/storage/logos/{{$disc.".png"}}" alt="" width="20" height="20"></span>
                       <span class="fecha_aviso">{{$disciplinas2->where('nombre_disc',$disc)->first()->nombre_disc }}</span>
                    </h6>
                  </a>
                  ...
                  <div class="collapse navbar-collapse btn-block position-absolute my-2 overflow-auto" id="navbarTogglerDemo01" style="left: 0%; z-index:1;background:#727378; max-height:300px">
        ...
        <div class="deporte col-md-12 d-block d-md-none" style="margin-bottom: 10px">
            <h5 class="fecha_aviso text-center" style="color:black">
        ...
        <div id="cargando" class="form-row justify-content-center mb-3" style="display:none">
