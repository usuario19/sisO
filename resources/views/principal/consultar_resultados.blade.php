...
@section('content')
<div class="container" style="background: #A1887F">
        <br><br>
        <div class="mx-auto col-md-6 bg-white">
                <div class="card-body text-center" style="margin: 20px">
                    <div class="col-md-12 text-center"  style="margin-bottom: 20px">
                        <h1 class="title-principal text-center" style="color: darkgray; font-size: 30px">resultados</h1>
                    </div>
                  
                    {!! Form::open(['route'=>'login.store','method' => 'POST']) !!}			
                    <div class="form-row">
                            <div class="">
                                <label class="title-span" for="id_gestion">GESTION</label>
                            </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select" id="id_participacion">
