        ...
        @foreach ($encuentros as $e)
            ...
            <th colspan="5">
                <div class="div_gestion row">
                    ...
                    <button onclick="Mostrar({{ $e->first()->id_gestion }},{{$disc}}, {{ $e->first()->id_fase }});" class="button_tb btn btn-link" data-toggle="modal" data-target="#modalTB">
                        <i class="material-icons" title="Tabla de posiciones">
                            equalizer
                        </i>
            ...
            <tbody>
                ...
                <td class="puntos text-center" style="padding:0%">
                        <div class="puntos mx-auto">
                         @if ($item->first()->goles >=0)
                          <span class="puntos">{{ $item->first()->goles }}</span>
                        ...
                        <td class="puntos text-center">
                              <span class="vs text-center">{{ " vs " }}</span>
                        </td>
                        <td class="puntos text-center"  style="padding:0%">
                        <div class="puntos mx-auto">
                          @if ($item->first()->goles >=0)
                            <span class="puntos">{{ $item->last()->goles }}</span>
                ...
                <th colspan="5" style="padding: 0%">
                    ...
                    <div class="form-group col-6 text-center">
                        ...
                        @endphp
                        <span class="icon_calendario" style="color: grey">
                        <i class="material-icons icon_calendario">
                            access_time
                        </i>
                        {{ $hora }}</span>
       ...
       @foreach ($encuentros as $e)
                      ...
                      <tr>
                        ...
                        <th colspan="6">
                            <div class="div_gestion row">
                              ...
                              <div class="col-md-6 col-4">
                              <button class="button_tb btn btn-link" data-toggle="modal" data-target="#modalTB">
                                  <i class=" material-icons" title="Tabla de posiciones">
                                      equalizer
                                  </i>
                ...
                <tr class="table-bordered">
                    <td>{{$i}}</td>
                                ...
                                <td>
                                    <img class="rounded-circle img-thumbnail" src="/storage/fotos/{{$jugador->foto_jugador}}" alt="logo" height="50" width="50" style="padding-inline-end: 5px">
                                </td>
                                <td>
                                    {{$jugador->nombre_jugador." ".$jugador->apellidos_jugador }}
                                </td>
