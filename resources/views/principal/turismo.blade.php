  ...
  <nav class="navbar navbar-expand-lg menu">
      <ul class="navbar-nav btn-block">
        <li class="nav-item link competicion col-md-6">
          <a class="nav-link link active  col-md-12" href="{{ route('principal.turismo') }}"><span class="lista_sub">LUGARES TURÍSTICOS</span></a>
        </li>
        <li class="nav-item link competicion col-md-6">
          <a class="nav-link link  col-md-12" href="{{ route('principal.gastronomia') }}"><span class="lista_sub">LUGARES GASTRONÓMICOS</span></a>
        </li>
      </ul>
    </nav>
              ...
              <div class="carousel-item">
                ...
                <div class="carousel-item">
                  ...
                  <div class="carousel-item">
                    ...
                    <div class="carousel-item">
                        <img src="/storage/foto_disc/9.jpg" class="d-block  w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                          <h5>Third slide label</h5>
                          <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
                        </div>
